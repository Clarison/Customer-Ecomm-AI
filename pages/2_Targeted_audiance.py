...
st.markdown(f"<h5>Most of our Customers are <b>{most_common_marital} {most_common_gender}</b> having <b>{most_common_education}</b> education.<br>Their average Purchasing Power is <b>{avg_purchase_estimate}</b> and Income somewhere between <b>{avg_lower_bound}</b> and <b>{avg_upper_bound}</b> having <b>{most_common_credit}</b> credit score.</h5>", unsafe_allow_html=True)
